...
#==
# This test file ensures that invite codes can be added through the admin panel.
#
# It creates an admin user, who then creates an invite code, and it confirms the
# invite code exists in the stash for the /admin/invites page.
#==
...
# Check to ensure that the invite code exists now.
$t->get_ok( '/admin/invites' )
    ->status_is( 200 )
    ->code_block( sub {
        my $self = shift;
