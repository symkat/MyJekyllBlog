...
#==
# This test ensures that a blog post can be edited in the editor panel
#
...
# 6. Load the editor for that blog post.
#==
...
$t->get_ok( "/dashboard/blog/$blog_id/post/edit?mdfile=2022-11-27-first-post.markdown" )
    ->status_is( 200 )
    ->code_block( sub {
        my $self = shift;
        is $self->stash->{post}->markdown, 'This is my first post', 'Post editor loaded post.';
    });
