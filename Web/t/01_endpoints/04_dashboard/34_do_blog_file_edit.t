...
#==
# This test ensures that blog files can be edited.
#
...
# 5. Create that file.
# 6. Put content into that newly created file.
# 7. Confirm the content has been correctly added to the file.
#==
...
$t->get_ok( "/dashboard/blog/$blog_id/file?name=mytest.md" )
    ->status_is( 302 )
...
# Post the content to the file that we just created.
$t->post_ok( "/dashboard/blog/$blog_id/file/edit", form => {
        file_name => 'mytest.md',
        file_path => "",
        content   => 'Hello World!',
    })
...
$t->get_ok( "/dashboard/blog/$blog_id/file?name=mytest.md" )
    ...
    ->code_block( sub {
        ...
        is $self->stash->{file_content}, 'Hello World!', 'Have correct file content.';
    });
