...
#==
# This test ensures that a blog post can be edited.
#
...
$t->post_ok( "/dashboard/blog/$blog_id/post/edit", form => {
...
# Try to read the post we edited and confirm it's correct.

is $t->app->jekyll( 'blog.example.com' )->get_post( '2022-11-27-first-post.markdown' )->headers->{title},
    'First Post!', 'The title of the post is correct.'; 

is $t->app->jekyll( 'blog.example.com' )->get_post( '2022-11-27-first-post.markdown' )->markdown,
    'This is my first edited post', 'The content of the post is correct.'; 
